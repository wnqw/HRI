...
class GameState {
    ...
    constructor(map, agents, loc, goal = 1, collected=[], policy = null, all_locs = null, all_deliver_places=null, map_set = null){
        this.map = map;
...
let stage_1 = new GameState(map_1, player_list, loc_list, goal= 3, [],
                                    policy = pi_1, all_locs = all_locs_1, all_deliver_places = all_deliver_places_1, map_set=1);
...
let stage_2 = new GameState(map_2, player_list, loc_list, goal= 3, [],
                                    policy = pi_2, all_locs = all_locs_2, all_deliver_places = all_deliver_places_2, map_set=1);
...
let stage_3 = new GameState(map_3, player_list, loc_list, goal= 3, [],
                                    policy = pi_3, all_locs = all_locs_3, all_deliver_places = all_deliver_places_3, map_set=1);
...
let stage_4 = new GameState(map_4, player_list, loc_list, goal= 3, [],
                                    policy = pi_4, all_locs = all_locs_4, all_deliver_places = all_deliver_places_4, map_set=1);
...
let stage_5 = new GameState(map_5,  player_list, loc_list, goal= 1, [],
                                    policy = pi_5, all_locs = all_locs_5, all_deliver_places = all_deliver_places_5, map_set=2);
...
let stage_6 = new GameState(map_6,  player_list, loc_list, goal= 1, [],
                                    policy = pi_6, all_locs = all_locs_6, all_deliver_places = all_deliver_places_6, map_set=2);
...
let stage_7 = new GameState(map_7,  player_list, loc_list, goal= 1, [],
                                    policy = pi_7, all_locs = all_locs_7, all_deliver_places = all_deliver_places_7, map_set=2);
...
let stage_8 = new GameState(map_8,  player_list, loc_list, goal= 1, [],
                                    policy = pi_8, all_locs = all_locs_8, all_deliver_places = all_deliver_places_8, map_set=2);
...
const opt_pi_human_9 = {
    "0":["@:2:6","b:2:2","B1"]
}
const all_locs_9 = ["@:1:1","a:1:1"];
const all_deliver_places_9 = ["A1"];

let stage_9 = new GameState(map_9,  player_list, loc_list, goal= 1, [],
                                    policy = pi_9, all_locs = all_locs_9, all_deliver_places = all_deliver_places_9, map_set=3);
...
const opt_pi_human_10 = {
    "0":["@:2:6","b:2:2","B1"]
}
const all_locs_10 = ["@:1:1","a:1:1"];
const all_deliver_places_10 = ["A1"];

let stage_10 = new GameState(map_10,  player_list, loc_list, goal= 1, [],
                                    policy = pi_10, all_locs = all_locs_10, all_deliver_places = all_deliver_places_10, map_set=3);
...
const opt_pi_human_11 = {
    "0":["@:2:6","b:2:2","B1"]
}
const all_locs_11 = ["@:1:1","a:1:1"];
const all_deliver_places_11 = ["A1"];

let stage_11 = new GameState(map_11,  player_list, loc_list, goal= 1, [],
                                    policy = pi_11, all_locs = all_locs_11, all_deliver_places = all_deliver_places_11, map_set=3);
...
const opt_pi_human_12 = {
    "0":["@:2:6","b:2:2","B1"]
}
const all_locs_12 = ["@:1:1","a:1:1"];
const all_deliver_places_12 = ["A1"];

let stage_12 = new GameState(map_12,  player_list, loc_list, goal= 1, [],
                                    policy = pi_12, all_locs = all_locs_12, all_deliver_places = all_deliver_places_12, map_set=3);
...
const all_locs_template1 = ["@:1:1","@:2:6","a:1:1", "b:2:2"];
const all_deliver_places_template = ["A1", "B1"];

let stage_template1 = new GameState(map_template_1, player_list, loc_list, goal= 1, [],
    policy = pi_template1, all_locs = all_locs_template1, all_deliver_places = all_deliver_places_template, 1);
...
const experiment_stages = [stage_1, stage_2, stage_3, stage_4, stage_5, stage_6, stage_7, stage_8, stage_9, stage_10, stage_11, stage_12];
// const experiment_stages = [stage_1, stage_5, stage_9];
